<section class="menu-section-area @auth isLoginMenu @endauth">
    ...
    <nav class="navbar sticky-header navbar-expand-lg" id="mainNav">
        <div class="container-fluid">
            <a class="navbar-brand" href="{{ url('/') }}"><img class="topLogo" src="{{ getImageFile(get_option('app_logo')) }}" alt="Logo"></a>
            ...
            <div class="main-menu-collapse collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <div class="header-nav-left-side me-auto text-dark d-flex">
                ...
                <div class="header-nav-right-side d-flex">
                    <ul class="navbar-nav">
                        <li class="nav-item dropdown overTextBlack">
                            <a class="menu-color-dark dropdown-toggle" href="#" data-bs-toggle="dropdown">{{__('Pages')}}</a>
                        ...
                        @if(@auth::user()->role == 2 || @auth::user()->role == 3)
                            <li class="nav-item">
                                <a class="menu-color-dark" href="{{ route('forum.index') }}">{{__('Forum')}}</a>
                            </li>
                            @if(@auth::user()->role == 3 )
                                @if(@auth::user()->instructor)
                                    <li class="nav-item">
                                        <span class="menu-color-dark">{{__('Request Pending')}}</span>
                                    </li>
                                @else
                                    <li class="nav-item">
                                        <a class="menu-color-dark" href="{{route('student.become-an-instructor')}}">{{__('Become an Instructor')}}</a>
                                    </li>
                                @endif
                            @elseif(@auth::user()->role == 2)
                                ...
                                @if(@auth::user()->instructor->status == 1)
                                    @if(\Illuminate\Support\Str::contains(url()->current(), 'instructor'))
                                        <li class="nav-item">
                                            <a class="menu-color-dark" href="{{route('student.dashboard')}}">{{__('Student Panel')}}</a>
                                        </li>
                                    @else
                                        <li class="nav-item">
                                            <a class="menu-color-dark" href="{{route('instructor.dashboard')}}">{{__('Instructor Panel')}}</a>
                                        </li>
                                    @endif
                                @elseif(@auth::user()->instructor->status == 2)
                                    <li class="nav-item">
                                        <span class="menu-color-dark">{{__('Blocked From Instructor Panel')}}</span>
                                    </li>
                                @else
                                    <li class="nav-item">
                                        <span class="menu-color-dark">{{__('Request Pending')}}</span>
                        ...
                        @else
                            ...
                            <li class="nav-item">
                                <a class="menu-color-dark" href="{{ route('blogs') }}">{{__('Blog')}}</a>
                            </li>
                            <li class="nav-item">
                                <a class="menu-color-dark" aria-current="page" href="{{ route('contact') }}">{{__('Contact')}}</a>
                            </li>
                        @endif
...
{{--                                <!-- Menu User Dropdown Menu Option End -->//nav-link theme-button1--}}
                            @else
                                <li class="nav-item  menu-sign-in-btn">
                                    <a href="{{ route('login') }}" class="frontLoginBtn" aria-current="page">{{__('Sign In')}}</a>
                                </li>
